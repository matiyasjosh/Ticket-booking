...
<body class="bg-gradient-to-r from-blue-500 to-teal-400 min-h-screen flex items-center justify-center">
    <div class="bg-white rounded-lg shadow-2xl p-8 w-96 animate-slide-up">
        ...
        <form id="signupForm" class="space-y-6">
            <div>
                ...
                <div class="relative">
                    <input type="text" name="username" required
                        class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:border-blue-500 transition-all"
            ...
            <button type="submit" 
                    class="w-full bg-blue-500 hover:bg-blue-600 text-white py-2 rounded-lg transition-all duration-300 transform hover:scale-105">
                Sign Up
            </button>
        </form>
        ...
        <p class="text-center mt-4">
            ...
            <a href="login.php" class="text-blue-500 hover:text-blue-600 font-semibold">Login</a>
        </p>
