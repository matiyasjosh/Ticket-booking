    ...
    <div class="max-w-7xl mx-auto px-1">
        <div class="flex items-center justify-between h-16">
            ...
            <div class="hidden md:flex items-center space-x-8 text-white/50">
                ...
                <a href="#" class="hover:text-white/80">Theaters</a>
                ...
                <?php if (isset($_SESSION['user'])): ?>
                    ...
                    <div class="relative group">
                        <button class="flex items-center space-x-2 px-4 py-2 rounded-lg bg-white/10 text-white hover:bg-white/20">
                ...
                <?php else: ?>
                    ...
                    <a href="login.php" class="px-4 py-2 rounded-lg border border-white text-white hover:bg-white hover:text-black">
                        Login
                    </a>
                    <a href="signup.php" class="px-4 py-2 rounded-lg bg-white text-black hover:bg-white/90">
                        Sign Up
                    </a>
                <?php endif; ?>
            </div>
